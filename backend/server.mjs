...
import wholesalerRoutes from './routes/wholesalerRoutes.mjs'; // Importar la ruta del mayorista
...
app.use('/api/wholesaler', wholesalerRoutes); // Montar las rutas del mayorista en /api/wholesaler
app.use('/remitos', express.static(path.join(__dirname, 'remitos')));
